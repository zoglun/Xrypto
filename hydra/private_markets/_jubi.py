...
class Jubi(Market):
    ...
    def _get_order(self, order_id):
        res = self.trade_client.get_order(coin=self.pair_code, trade_id=int(order_id))
    ...
    def _cancel_order(self, order_id):
        res = self.trade_client.cancel_order(coin=self.pair_code, trade_id=int(order_id))
