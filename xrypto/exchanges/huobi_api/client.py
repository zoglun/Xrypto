...
class Client:
    ...
    def buy_limit(self, price, amount, trade_password=None,
    ...
    def sell_limit(self, price, amount, trade_password=None,
             trade_id=None, coin_type='btc'):
        params = {
            'method': 'sell',
            'price': price,
    ...
    def get_depth(self,  currency='cny', coin_type='btc', count=999):
        if currency == 'usd':
            market = 'usd'
        else:
            market = 'static'
